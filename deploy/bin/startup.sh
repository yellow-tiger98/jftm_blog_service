...
JAVA_OPT="${JAVA_OPT} --logging.config=${BASE_DIR}/conf/log4j2-spring.xml"
...
nohup $JAVA ${JAVA_OPT} jftmBlog >> ${BASE_DIR}/logs/start.out 2>&1 &
echo "jftmBlog is starting，you can check the ${BASE_DIR}/logs/start.out"
